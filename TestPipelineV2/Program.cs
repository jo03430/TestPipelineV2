...
using TestPipelineV2.Domain;
using TestPipelineV2.Domain.Auth;
...
using TestPipelineV2.Configure.Swagger;
...
builder.Host.ConfigureContainer<ContainerBuilder>(containerBuilder =>
{
    ...
    containerBuilder.RegisterModule<TestPipelineV2DomainAutofacRegistration>();
});
...
app.UseSwaggerUI(options =>
{
    ...
    options.DocumentTitle = environment.IsProduction() ? "TestPipelineV2 API" : $"{environment.EnvironmentName} - TestPipelineV2 API";
});
