...
namespace TestPipelineV2.Configure.Swagger
{
        ...
        : IConfigureNamedOptions<SwaggerGenOptions>
    {
        ...
        public void Configure(SwaggerGenOptions options)
        {
            ...
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestPipelineV2.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestPipelineV2.Domain.xml"));
